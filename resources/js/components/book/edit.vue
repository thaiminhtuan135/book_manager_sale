                        ...
                        <CCardBody>
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    <div class="col-sm-12 d-flex justify-content-between">
                                        <div class="col-sm-5">
                                            ...
                                            <div>
                                                <Field id="title" placeholder="Tiêu đề" class="form-control" name="title" v-model="model.title" readonly/>
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <div>
                                                <Field class="form-control" id="author" placeholder="Tác giả" name="author" v-model="model.author" readonly/>
                                ...
                                <div class="col-sm-6 justify-content-center d-flex">
                                    <button disabled id="btnUpload" class="bor rounded-4 mt-5" type="button" style="height: 50px;background-color: seagreen;color: white" @click="chooseImage">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div>
                                        <textarea placeholder="Mô tả sách" name="description" id="description" cols="87" rows="6" disabled></textarea>
                                    </div>
                                    <div class="row d-flex justify-content-between">
                                        <div class="col-sm-5">
                                            <label class="mt-3 mb-2 bold-char" for="">Ngày phát hành </label>
                                            <div>
                                                <Field id="release_date" placeholder="XXXX-XX-XX" class="form-control" name="release_date" v-model="model.release_date" readonly/>
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <div>
                                                <Field class="form-control" id="number_page" placeholder="Số trang" name="number_page" v-model="model.number_page" readonly/>
                                    ...
                                    <div class="searchFrom d-flex align-items-center" style="justify-content: center">
                                        <div class="img-display" id="img" @click="chooseImage()" role="button" style="justify-content: center" :class="status ? '' : 'not-active'">
                                            ...
                                            <img id="anh" class="align-items-center justify-content-center mb-1 mt-1"
                                                 v-if="filePreviewWeb" :src="status ? filePreviewWeb : getLogo(filePreviewWeb)" style=" max-width: 500px; max-height: 280px"/>
                                            <img id="anh1" v-if="check" :src="getLogo(file)"
                                                 class="align-items-center justify-content-center mb-1 mt-1" style="max-width: 500px; max-height: 280px"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                                <button class="btn btn-primary w-100">Edit</button>-->
                                <div @click="changeStatus" class="btn btn-primary w-100" id="btnEdit">Edit</div>
                                <button type="submit" id="btnSave" class="btn btn-primary w-100 hidden" >Save</button>
                            </div>
                        </CCardFooter>
                    </form>
                </VeeForm>
            </CCard>
            <img src="http://localhost/storage/image-media/03ae90ba4d544e27b4dec91b272b09ab1a3f0891.jpg" alt="">
            <div>tuan</div>
        </div>
    </div>
